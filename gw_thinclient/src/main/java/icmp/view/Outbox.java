...
public class Outbox extends javax.swing.JFrame {
    private static String LIST_ALL = "from SMS s where s.status='2'";
    private static String SEARCH_NUM = "from SMS s where s.toNumber like '%";
    ...
    private void search() {
        executeHQLQuery(SEARCH_NUM + searchBox.getText() + "%' " + 
                        OR_SEARCH_MSG + searchBox.getText() +"%' and s.status='2'");
    }
